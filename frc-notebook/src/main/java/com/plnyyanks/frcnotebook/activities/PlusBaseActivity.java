...
import com.plnyyanks.frcnotebook.helpers.GCMHelper;
...
public abstract class PlusBaseActivity extends Activity
    ...
    /**
     * Disconnect the {@link com.google.android.gms.plus.PlusClient} only if it is connected (otherwise, it can throw an error.)
